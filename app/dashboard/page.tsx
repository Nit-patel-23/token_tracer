  ...
  return (
    <div suppressHydrationWarning>
      ...
      <header>
        ...
        <div id="roots" suppressHydrationWarning>
          scanning…
        </div>
        <div className="header-user" id="header-user" suppressHydrationWarning>
          <span id="user-name" className="user-name" />
          <button id="logout-btn" className="hbtn" title="Sign out">
            Sign out
          </button>
        </div>
        <button id="wrapped-btn" className="hbtn" title="Your usage, as a story">
          ✦ Wrapped
        </button>
        <button id="refresh" className="hbtn" title="Rescan session files">
          ↻ Refresh
        </button>
      </header>
      <div className="layout">
        ...
        <nav id="tree" aria-label="Session spawn tree" suppressHydrationWarning>
          <div
            className="app-loading-hero"
            style={{ margin: '8px', minHeight: '120px', padding: '18px 12px' }}
          >
